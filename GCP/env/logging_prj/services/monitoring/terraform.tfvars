...
monitored_projects = [
  "ndf-network-prj-mec2-01",
  "ndf-infraservices-prj-mec2-01",
  "ndf-prod-prj-mec2-01",
  "ndf-security-prj-mec2-01"
]
...
alert_policies = {
  instance_uptime = {
    display_name  = "NDF Compute Instance Uptime check"
  ...
  disk_read_ops = {
    display_name  = "NDF Compute Disk Read Ops"
  ...
  disk_write_ops = {
    display_name  = "NDF Compute Disk Write Ops"
  ...
  total_bytes = {
    display_name  = "NDF Cloud Storage Usage"
  ...
  firewall_dropped_packets = {
    display_name  = "NDF Firewall Dropped Packets"
  ...
  vpn_tunnel_status = {
    display_name  = "NDF VPN Tunnel Established"
  ...
  bgp_session_status = {
    display_name  = "NDF Router BGP Session Status"
  ...
  # lb_connection_limit = {
  #   display_name    = "NDF LB Connection Limit Reached"
  ...
  #   display_name    = "NDF LB Connection Refused"
  ...
  # lb_dns_error = {
  #   display_name    = "NDF LB DNS Errors"
  ...
  #   display_name    = "NDF LB HTTP Protocol Errors"
  ...
  lb_backend_request_count = {
    display_name    = "NDF LB Backend Request Count"
  ...
  #   display_name    = "NDF LB Backend Response Latency"
  ...
  lb_request_count = {
    display_name    = "NDF LB Request Count"
  ...
  lb_backend_latencies = {
    display_name    = "NDF LB Backend Latencies"
  ...
  lb_5xx_count = {
    display_name    = "NDF LB 5xx Errors Count"
  ...
  # lb_failed_requests = {
  #   display_name    = "NDF LB Failed Requests"
  ...
  #   display_name    = "NDF LB Backend Unavailable"
  ...
  # lb_health_check = {
  #   display_name    = "NDF LB Backend Health Check Failed"
  ...
  # --- Cloud Storage ---
  # gcs_4xx_errors = {
  #   display_name    = "NDF GCS 4xx Errors"
  ...
  # gcs_5xx_errors = {
  #   display_name    = "NDF GCS 5xx Errors"
  ...
  #   display_name    = "NDF NAT Connections"
